...
function() {
    ...
    AbstractChosen = function() {
        ...
        AbstractChosen.prototype.set_default_text = function() {
            ...
            this.results_none_found = this.form_field.getAttribute("data-no_results_text") || this.options.no_results_text || "未找到匹配"
        },
    ...
    Chosen = function(_super) {
        ...
        Chosen.prototype.set_up_html = function() {
            ...
            container_div = $("<div />", {
                ...
                style: "width: " + this.f_width * 0.5 + "px;"
            }),
        ...
        Chosen.prototype.set_tab_index = function(el) {
            ...
            this.search_field.attr("tabindex", ti)
        },
        ...
        Chosen.prototype.choice_destroy = function(link) {
            if (this.result_deselect(link.attr("rel"))) return this.choices -= 1,
            this.show_search_field_default(),
        ...
        Chosen.prototype.result_deselect = function(pos) {
            ...
            this.form_field.options[result_data.options_index].disabled ? !1 : (result_data.selected = !1, this.form_field.options[result_data.options_index].selected = !1, result = $("#" + this.container_id + "_o_" + pos), result.removeClass("result-selected").addClass("active-result").show(), this.result_clear_highlight(), this.winnow_results(), this.form_field_jq.trigger("change", {
        ...
        Chosen.prototype.winnow_results = function() {
            ...
            for (_i = 0, _len = _ref.length; _i < _len; _i++) {
                ...
                if (!option.disabled && !option.empty) if (option.group) $("#" + option.dom_id).css("display", "none");
                    ...
                    if(option.html.indexOf(searchText) != -1)
                    {
                        found = !0, results += 1;
                    }
                    ...
                    if(found)
                    {
                        ...
                        else
                        {
                           ...
                           option.group_array_index != null && $("#" + this.results_data[option.group_array_index].dom_id).css("display", "list-item") 
                        }
                    }
                    else
                    {
                        this.result_highlight && result_id === this.result_highlight.attr("id") && this.result_clear_highlight();
        ...
        Chosen.prototype.keydown_backstroke = function() {
            ...
            if (next_available_destroy.length && !next_available_destroy.hasClass("search-choice-disabled")) return this.pending_backstroke = next_available_destroy,
